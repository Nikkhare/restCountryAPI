    ...
    <div v-if="countryInfo" class="tileGrid">
      <div v-for="country in filteredCountries" class="countryTile" v-bind:key="country.id">
        ...
        >
          ...
          <div class="text">
            <h1>{{ country.name }}</h1>
            <p><span>2 character: </span> {{ country.alpha2Code }}</p>
            <p><span>3 character: </span> {{ country.alpha3Code }}</p>
            <p><span>Native name: </span> {{ country.nativeName }}</p>
            <p><span>Country Name: </span> {{ country.altSpellings }}</p>
            <p><span>Calling Codes: </span> {{ country.callingCodes }}</p>
